...
{
    [TestClass]
    public class AddressMVCControllerTest
    {
        private AddressController controller;
        private readonly Mock<IMediator> _mediator;
        private readonly IMapper _mapper;

        public AddressMVCControllerTest()
        {
        ...
        [TestMethod]
        public async Task Index(GetAllAddressesQuery query)
        {
        ...
        [TestMethod]
        public async Task Update(GetAddressByIdQuery query)
        {
