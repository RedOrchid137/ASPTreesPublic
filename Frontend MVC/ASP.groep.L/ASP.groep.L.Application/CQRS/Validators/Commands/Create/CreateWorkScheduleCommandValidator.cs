                ...
                .DependentRules(() =>
                {
                    RuleFor(e => e.WorkSchedule).Cascade(CascadeMode.StopOnFirstFailure)
                      .Must(e =>
                      {
                          ...
                          return (e.EmployeeTasks.OrderBy(e => e.scheduledStart.Day).Last().scheduledStart - e.EmployeeTasks.OrderBy(e => e.scheduledStart.Day).First().scheduledStart).TotalDays < 7;
                      }
                      )
                    ...
                    RuleFor(e => e.WorkSchedule.EmployeeTasks).Cascade(CascadeMode.StopOnFirstFailure)
                        .NotNull()
                        .Must(e =>
                        {
