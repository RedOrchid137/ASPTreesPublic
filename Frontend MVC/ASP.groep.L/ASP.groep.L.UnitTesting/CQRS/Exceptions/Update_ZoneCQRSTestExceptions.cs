...
namespace ASP.groep.L.UnitTesting.CQRS.Exceptions
{
    ...
    [TestClass]
    public class Update_ZoneCQRSTestExceptions
    {
        private readonly Mock<IMediator> _mediator;

        private Zone standardZone;
        public Update_ZoneCQRSTestExceptions()
        {
        ...
        [TestMethod]
        public async Task UpdateZoneTest_NotNullFailure()
        {
        ...
        [TestMethod]
        public async Task UpdateZoneTest_TreeSpecies3LimitFailure()
        {
            var validator = new UpdateZoneCommandValidator();
            var command = new UpdateZoneCommand();
