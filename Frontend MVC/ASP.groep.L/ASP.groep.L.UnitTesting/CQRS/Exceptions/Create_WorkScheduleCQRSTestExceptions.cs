...
namespace ASP.groep.L.UnitTesting.CQRS.Exceptions
{
    ...
    [TestClass]
    public class Create_WorkScheduleCQRSTestExceptions
    {
        private readonly Mock<IMediator> _mediator;
        private List<EmployeeTask> standardTasks;

        private WorkSchedule standardSchedule;
        public Create_WorkScheduleCQRSTestExceptions()
        {
        ...
        [TestMethod]
        public async Task CreateWorkScheduleTest_NotNullFailure()
        {
            var validator = new CreateWorkScheduleCommandValidator();
        ...
        [TestMethod]
        public async Task CreateWorkScheduleTest_TaskLengthFailure()
        {
            var validator = new CreateWorkScheduleCommandValidator();
            var command = new CreateWorkScheduleCommand();
        ...
        [TestMethod]
        public async Task CreateWorkScheduleTestTasks_WithinWeekFailure()
        {
            var validator = new CreateWorkScheduleCommandValidator();
            var command = new CreateWorkScheduleCommand();        
            command.WorkSchedule = standardSchedule;
            var tasks = command.WorkSchedule.EmployeeTasks.ToList();
            tasks[0].scheduledStart = DateTime.Now;
            tasks[1].scheduledStart = DateTime.Now.AddDays(8);
            ValidationResult res = validator.Validate(command);
            res.Errors.Count.ShouldBeGreaterThan(0);
            res.Errors[0].ErrorMessage.ShouldBe("Work Schedule has to contain days within the same week");
        }
        [TestMethod]
        public async Task CreateWorkScheduleTestTasks_5DaysFailure()
        {
            var validator = new CreateWorkScheduleCommandValidator();
            var command = new CreateWorkScheduleCommand();
            command.WorkSchedule = standardSchedule;
        ...
        [TestMethod]
        public async Task CreateWorkScheduleTestTasks_ZoneEveryDayFailure()
        {
            var validator = new CreateWorkScheduleCommandValidator();
            var command = new CreateWorkScheduleCommand();
            command.WorkSchedule = standardSchedule;
            var tasks = command.WorkSchedule.EmployeeTasks.ToList();
            tasks[0].scheduledStart = DateTime.Now;
            tasks[0].scheduledStop = DateTime.Now.AddHours(2);
            tasks[1].scheduledStart = DateTime.Now.AddDays(1);
            tasks[1].scheduledStop = DateTime.Now.AddDays(1).AddHours(2);
            tasks.Add(new EmployeeTask { scheduledStart = DateTime.Now.AddDays(2), scheduledStop = DateTime.Now.AddDays(2).AddHours(2), ZoneId =2 });
            command.WorkSchedule.EmployeeTasks = tasks;
            ValidationResult res = validator.Validate(command);
            res.Errors.Count.ShouldBeGreaterThan(0);
        ...
        [TestMethod]
        public async Task CreateWorkScheduleTestTasks_AddTaskNotNullFailure()
        {
            var validator = new CreateWorkScheduleCommandValidator();
            var command = new CreateWorkScheduleCommand();
            command.WorkSchedule = standardSchedule;
        ...
        [TestMethod]
        public async Task CreateWorkScheduleTestTasks_EmployeeSiteLimitFailure()
        {
            var validator = new CreateWorkScheduleCommandValidator();
            var command = new CreateWorkScheduleCommand();
            command.WorkSchedule = standardSchedule;
        ...
        [TestMethod]
        public async Task CreateWorkScheduleTestTasks_Employee4taskLimitFailure()
        {
            var validator = new CreateWorkScheduleCommandValidator();
            var command = new CreateWorkScheduleCommand();
            command.WorkSchedule = standardSchedule;
        ...
        [TestMethod]
        public async Task CreateWorkScheduleTestTasks_EmployeeZoneLimitFailure()
        {
            var validator = new CreateWorkScheduleCommandValidator();
            var command = new CreateWorkScheduleCommand();
            command.WorkSchedule = standardSchedule;
